...
export const gameData = [
...

    {
        ...
        외부링크: "없음",
        플랫폼: ["PC", ""],
        txt: "만 하루동안 해가 사라졌던 이 날 이후 세계 곳곳에서 신비한 현상들에 대한 소식이 들려 왔다.자고 일어나니 황무지 위에 도시가 생겨났다거나, 특별한 능력을 가진 아이들이 태어났다거나. 어떤 이는 신비한 도시들을 찾아 모험을 떠났고 어떤 이는 초능력을 가진 아이들을 이용해 큰 돈을 벌어들였다. 사람들은 그들을 사이퍼라 부르며 탄압했고 그러한 차별에 반발하여 헬리오스라는 회사가 설립되었다. 헬리오스 사는 능력자들에게 일자리를 주고 각국 정부와 교섭을 하는 등 능력자들의 권익과 생존권을 보호하기 위해 노력했다. 마침내 모든 능력자, 나아가 세계의 미래를 결정지을 싸움이 지금 막 시작되려 하고 있다.",
        이미지: ["", "", "", ""],
    },
    {
        idx: "14",
    ...
    },
    {
        ...
        플랫폼: ["PC", ""],
        txt: "테일즈위버는 유저들의 협력을 중심으로 누구나 즐겁게, 함께 스토리를 즐길 수 있는 게임이라는 부분에 포커스를 맞추고 있습니다. 이를 위해 테일즈위버에서 다른 무엇보다도 중점을 두고 있는 것은 '함께 즐기는 감동적인 시나리오'와 '박진감 넘치는 전투'라는 두 가지 요소로써, 실제 게임을 플레이하는 유저들은 온라인게임 환경에서 여러 플레이어가 함께 진행 가능한 드라마틱한 시나리오를 구현해주는 이벤트 시스템과 기존의 온라인 게임과는 전혀 다른 박진감 넘치는 전투 시스템을 통해서 기존의 성장 중심의 게임이나 가상 사회 스타일의 게임과는 차별화된 테일즈위버만의 새로운 재미를 느끼게 될 것입니다.",
        이미지: ["", "", "", ""],
    },
];
