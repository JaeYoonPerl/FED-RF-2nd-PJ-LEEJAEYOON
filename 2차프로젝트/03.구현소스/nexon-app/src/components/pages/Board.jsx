            ...
            <td>
              {
                ...
                mode == "L" && sts && (
                  <button onClick={clickButton}>작성하기</button>
                )
              }
              {
                // 2. 읽기상태 "R" 일 경우
...

                  {
                    ...
                    mode == "R" &&
                      ...
                      JSON.parse(sts).uid == selRecord.current.uid && (
                        <button onClick={clickButton}>수정하기</button>
                      )
                  }
                </>
              }
              {
                ...
                mode == "W" && (
                  <>
                    <button onClick={clickButton}>업로드</button>
              ...
              }
              {
                ...
                mode == "M" && (
                  <>
                    <button onClick={clickButton}>업로드</button>
                    <button onClick={clickButton}>지우기</button>
                    <button onClick={clickButton}>목록</button>
                  </>
                )
              }
      ...
      <table className="dtbl" id="board">
        <thead>
          <tr>
            ...
            <th>작성자</th>
            <th>날짜</th>
            <th style={{whiteSpace:"nowrap"}}>조회수</th>
          </tr>
        </thead>
